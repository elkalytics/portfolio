#' Perform one-way ANOVA across data
#' 
#' This function performs a one-way ANOVA across all numeric variables and factor variables in a given data frame.
#' 
#' @param df A data frame containing the variables to be analyzed.
#' @return A data frame containing the results of the ANOVAs performed.
#'
#' @examples
#' set.seed(123)
#' df <- data.frame(
